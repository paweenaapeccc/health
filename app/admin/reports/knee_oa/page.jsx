...
// ✅ ฟังก์ชันแปลงวันที่เป็นเวลาไทย (พ.ศ.)
...
// ✅ ฟังก์ชันแปลง label เพศ
const genderLabel = (g) => (g === 'male' ? 'ชาย' : g === 'female' ? 'หญิง' : 'ไม่ระบุ');

// ✅ ปิด SSR เพื่อป้องกัน Hydration mismatch
  ...
  return (
    <div className="min-h-screen ">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-8 space-y-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-end justify-center">
            ...
            <div className="flex gap-2">
              <button onClick={load} className="px-4 py-2 rounded bg-blue-600 text-white shadow hover:bg-blue-700 transition">
                โหลดข้อมูล
              </button>
              <button onClick={downloadCSV} disabled={!data} className="px-4 py-2 rounded border bg-gray-50 hover:bg-gray-100 transition">
                ดาวน์โหลด CSV
              </button>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                <div className="col-span-2 border rounded-lg p-4 bg-white dark:bg-gray-800">
                  ...
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Tooltip />
                        <Legend />
                        <Pie data={pieGenderData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100} label>
